...
public class VoteController {
    ...
    public final static int VOTE_INTERVAL = 30 * 60 * 1000; // 半个小时
    ...
    String handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            if (starttime != null) {//如果投过票判断时间是否大于半个小时
                Long endtime = date.getTimeInMillis();
                if (starttime - endtime - VOTE_INTERVAL > 0) {
                    isTrue = true;
                }
            } else {
                isTrue = true;
    ...
    public int addDBVote(int serverId) {
        ...
        if (serverSysInfo == null) {
            ...
            serverSysInfo.setVoteIn(serverSysInfo.getVoteIn());
        }
